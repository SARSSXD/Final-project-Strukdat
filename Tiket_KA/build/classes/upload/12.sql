...
-- Dumping data for table bedengan_db.data_user: ~3 rows (approximately)
INSERT INTO `data_user` (`id_user`, `nik`, `no_tlp`, `norek`, `tanggal_lahir`, `jk`, `alamat`) VALUES
	...
	(3, '3514091502040001', '08515969989', '12356278482', '2004-02-15', 'Laki-laki', 'Jl. Raya Glagahsari no.130 Sukorejo Pasuruan');
...
-- Dumping data for table bedengan_db.order: ~9 rows (approximately)
INSERT INTO `order` (`id_order`, `id_user`, `jml_pengunjung`, `tanggal`, `paket`, `metodbyr`, `buktibyr`, `status`, `total`) VALUES
	...
	(3, 1, 2, '0000-00-00', 'Paket 1', 'Transfer', 'src\\upload\\3.png', 'Belum Lunas', 'Rp. 20000'),
	(4, 2, 1, '2023-12-20', 'Paket 1', 'Tunai', NULL, 'Belum Lunas', 'Rp. 10000'),
	(5, 2, 2, '2023-12-21', 'Paket 2', 'Transfer', 'src\\upload\\5.PNG', 'Belum Lunas', 'Rp. 40000'),
	(6, 1, 3, '2023-12-18', 'Paket 3', 'Tunai', NULL, 'Belum Lunas', 'Rp. 90000'),
...
-- Dumping data for table bedengan_db.user: ~3 rows (approximately)
